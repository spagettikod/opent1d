...
func TestSaveSetting(t *testing.T) {
	...
	expectedSettings.LibreLinkUpEndpoint = "eu"
	...
	if expectedSettings.LibreLinkUpEndpoint != actualSettings.LibreLinkUpEndpoint {
		t.Fatalf("expected LibreLinkUpEndpoint value %s but got %s", expectedSettings.LibreLinkUpEndpoint, actualSettings.LibreLinkUpEndpoint)
	}
}
